...
Format:
[{"id":"1","prompt":"प्रश्न...","options":["A","B","C","D"],"answer":0,"explanation":"..."}]`
...
Format:
[{"id":"1","prompt":"Question...","options":["A","B","C","D"],"answer":0,"explanation":"..."}]`,

  quizUser: (topicSlug: string, language: "en" | "hi") =>
    language === "hi"
      ? `विषय: ${topicSlug}. इस विषय पर 5 MCQ बनाएं जो अवधारणा को वास्तव में परखें।`
...
Return JSON only: {"strengths":["..."],"weaknesses":["..."],"nextStep":"...","confidence":75}`,
  ...
  feedbackUser: (
    ...
    language === "hi"
      ? `विषय: ${topic}. स्कोर: ${score}% (${correct}/${total}). संक्षिप्त, सकारात्मक प्रतिक्रिया दें।`
      : `Topic: ${topic}. Score: ${score}% (${correct}/${total}). Give concise, positive feedback with one actionable next step.`,
